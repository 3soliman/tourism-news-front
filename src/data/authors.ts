...
export const authors: Author[] = [
  {
    ...
    bio: "يشرف على السياسة التحريرية للموقع ويركز على بناء محتوى سياحي عربي واضح وموثوق للمسافرين.",
  },
  {
    slug: "sara-al-zahrani",
    name: "سارة الزهراني",
    role: "محررة الفنادق والإقامة",
    image:
